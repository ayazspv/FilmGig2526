                ...
                <aside class="col-12 col-lg-4">
                    <div class="card border-0 shadow-sm rounded-4 h-100">
                        <div class="card-body p-4 text-center">
                            ...
                            <p class="mb-0" style="color: #1F2937;"><strong>Market:</strong> <?= htmlspecialchars($summary['market']) ?></p>
                        </div>
                    </div>
                </aside>
                ...
                <section class="col-12 col-lg-8">
                    <div class="card border-0 shadow-sm rounded-4 mb-4">
                        <div class="card-body p-4">
                            ...
                            <p class="mb-2"><strong>Contact Person:</strong> <?= htmlspecialchars($contact['contactPerson']) ?></p>
                    ...
                    <div class="card border-0 shadow-sm rounded-4">
                        <div class="card-body p-4">
                            ...
                            <p class="mb-0" style="color: #1F2937;"><?= htmlspecialchars($viewModel->about) ?></p>
                        </div>
                    </div>
                </section>
            </section>
