...
<article class="card border-0 shadow-sm rounded-4 w-100 overflow-hidden">
    <img src="<?= $e((string) ($gigItem['imageUrl'] ?? $gigItem['thumbnail'] ?? 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?auto=format&fit=crop&w=900&q=80')) ?>" class="card-img-top gigs-thumbnail" alt="<?= $e((string) ($gigItem['title'] ?? 'Gig Thumbnail')) ?>">
