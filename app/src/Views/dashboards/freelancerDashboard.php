...
$dashboardKind = $dashboardKind ?? 'freelancer';
    ...
    <main class="flex-grow-1 py-5" data-dashboard-root data-dashboard-api-endpoint="<?= htmlspecialchars($dashboardApiEndpoint) ?>" data-dashboard-kind="<?= htmlspecialchars($dashboardKind) ?>" data-dashboard-user-name="<?= htmlspecialchars((string) ($_SESSION['name'] ?? 'User')) ?>">
        <div class="container">
            ...
            <section class="mb-4">
                <div class="row g-4">
                        ...
                        <div class="card border-0 shadow-sm rounded-4 h-100">
                            <div class="card-body p-4">
                                <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2 mb-3">
                                    <h2 class="h4 fw-bold mb-0" style="color: #172554;" data-dashboard-applications-title>Loading applications...</h2>
                                    <a href="/dashboard/submissions" class="btn btn-sm btn-outline-secondary">Open Submissions</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table align-middle mb-0">
                                        <thead data-dashboard-applications-head></thead>
                                        <tbody data-dashboard-applications-body></tbody>
                                    </table>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="card border-0 shadow-sm rounded-4 h-100">
                            <div class="card-body p-4">
                                <h2 class="h4 fw-bold mb-3" style="color: #172554;" data-dashboard-recommended-title>Loading recommended gigs...</h2>
                                <div class="table-responsive">
                                    <table class="table align-middle mb-0">
                                        <thead data-dashboard-recommended-head></thead>
                                        <tbody data-dashboard-recommended-body></tbody>
                                    </table>
                                </div>
                            </div>
                        </div>
            ...
            <section class="mb-4">
                <div class="card border-0 shadow-sm rounded-4 h-100">
                    <div class="card-body p-4">
                        <h2 class="h4 fw-bold mb-3" style="color: #172554;" data-dashboard-recent-title>Loading recent activity...</h2>
                        <ul class="list-group list-group-flush" data-dashboard-recent-list></ul>
                    </div>
                </div>
            </section>
