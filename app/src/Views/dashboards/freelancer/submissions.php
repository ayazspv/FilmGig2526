            ...
            <section class="rounded-4 p-4 p-md-5 mb-4 text-white shadow-sm" style="background: linear-gradient(120deg, #172554 0%, #1F2937 100%);">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end gap-3">
                    ...
                    <div class="d-flex gap-2">
                        <a href="/gigs" class="btn btn-warning fw-semibold" style="color: #172554;">Browse Gigs</a>
            ...
            <section>
                <div class="card border-0 shadow-sm rounded-4">
                    <div class="card-body p-4">
                        <h2 class="h4 fw-bold mb-3" style="color: #172554;">Your Submission History</h2>
                                    ...
                                    <?php else: ?>
                                        <?php foreach ($submissions as $submission): ?>
                                            <tr>
                                                ...
                                                <td><?= htmlspecialchars($submission['gigCategory']) ?></td>
                                                <td><?= htmlspecialchars($submission['gigLocation']) ?></td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="d-flex flex-wrap gap-2">
                                                        ...
                                                        <?php if ($submission['canWithdraw']): ?>
                                                            <form method="POST" action="/dashboard/submissions/<?= htmlspecialchars((string) $submission['submissionId']) ?>/withdraw" class="d-inline">
                                                                <button type="submit" class="btn btn-sm btn-outline-danger" onclick="return confirm('Withdraw this submission?');">Withdraw</button>
                                                            </form>
                                                        <?php endif; ?>
                                                    </div>
                                                </td>
